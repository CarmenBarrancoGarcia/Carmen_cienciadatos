...
st.pyplot(fig)
st.caption('Gráfica de matplotlib univariante sobre flipper length')
...
st.html('<p style="text-align:center">Descargar el dataset original o con los filtros actuales</p>')
...
with col2: 
    st.download_button(
        ...
        file_name='penguins_filteres.csv',
        mime='text/csv'
    )
