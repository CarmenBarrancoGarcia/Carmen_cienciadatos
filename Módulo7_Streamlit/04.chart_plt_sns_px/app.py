...
ax.set_title('Análisis univariantes body_mass_g')
st.pyplot(fig)
...
ax.grid()
st.pyplot(fig)
# ax=ax si solo creamos una gráfica y no necesitamos controlas los ejes de manera explícita entonces no hace falta.
